...
import { Star, ArrowLeft, Linkedin, Twitter, Mail, Quote, Briefcase, GraduationCap } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-12 items-start">
            ...
            <div className="space-y-6">
                ...
                {/* --- BAGIAN SOCIAL LINKS (PASTIKAN DATA DI DB TERISI) --- */}
                <div className="flex gap-4 justify-center">
                    {teacher.linkedin && (
                         <a href={teacher.linkedin} target="_blank" className="p-3 bg-slate-900 border border-white/10 rounded-full text-slate-400 hover:text-white hover:border-cyan-500 transition-all group">
                            <Linkedin size={20} className="group-hover:scale-110 transition-transform"/>
                         </a>
                    )}
                    {teacher.twitter && (
                         <a href={teacher.twitter} target="_blank" className="p-3 bg-slate-900 border border-white/10 rounded-full text-slate-400 hover:text-white hover:border-cyan-500 transition-all group">
                            <Twitter size={20} className="group-hover:scale-110 transition-transform"/>
                         </a>
                    )}
                    {teacher.email && (
                         <a href={`mailto:${teacher.email}`} className="p-3 bg-slate-900 border border-white/10 rounded-full text-slate-400 hover:text-white hover:border-cyan-500 transition-all group">
